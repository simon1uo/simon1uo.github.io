    ...
    <div class="flex items-center">
      <div class="flex items-center gap-2">
        <div v-for="item in navItems" :key="item.text" class="relative transition-colors duration-1000">
          ...
          <a
            v-if="!item.items"
            class="hover:text-brand dark:hover:text-brand-dark block px-1 font-medium no-underline transition-colors duration-150 text-base"
          ...
          <div v-else class="group relative">
            <button
              class="block cursor-pointer border-none bg-transparent px-1 text-[var(--vp-c-text-2)] font-medium transition-colors duration-250 hover:text-[var(--vp-c-text-1)]"
            >
              {{ item.text }}
            </button>
            <div
            ...
            >
              <a
                v-for="subItem in item.items" :key="subItem.text"
